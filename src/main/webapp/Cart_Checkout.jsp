...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <p style="color: red; font-weight: bold; font-size: 30px; margin-left: 550px">Bạn cần đăng nhập để mua vé</p>
</c:if>
        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding-left: 30px;" class="align-middle"><strong
                                                        id="priceItem">${fl.cost}</strong></td>

                                                <td style="padding-left: 40px;" class="align-middle">
                                                    <strong>${fl.numT}</strong>
                                                </td>
                                                <td class="align-middle">
                                                    ...
                                                    <input name="quanlityduc"
                                                        ...
                                                        id="form1" min="1" max="${fl.numT}" value="1" type="number"
                        ...
                        <div class="row py-5 p-4 bg-white rounded shadow-sm">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div style="text-align: right;" class="p-4">
                                    <ul class="list-unstyled mb-4">
                                        ...
                                        <li class="d-flex justify-content-between py-3 border-bottom"><strong
                                            ...
                                            <h5 name="total" style="margin-left: 250px; font-size: 20px; color: red;"
                                                class="font-weight-bold" id="totalAmount">${fl.cost}</h5>
                                            <h5 style="font-size: 20px; font-weight: bold; margin-top: 10px;">VNĐ</h5>
                                        </li>
                                    </ul>
                                ...
                                border-color: #000;" type="button" class="btn btn-primary" data-toggle="modal"
                                        ...
                                        ${empty sessionScope.acc ? 'disabled' : ''}
		...
		<script>
            function checkout() {
                ...
                window.location.href = 'QRCode.jsp?fid=' + ${fl.id} + '&quanlity=' + quanlity + '&totalA=' + encodeURIComponent(totalAmount);
            }
        </script>
