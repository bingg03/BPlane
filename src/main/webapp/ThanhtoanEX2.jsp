...
<body>
    <form action="UI_MainCart.html">
        ...
        <div class="button-container">
            <input style="margin-left: 70px;" type="button" class="btn btn-default" data-dismiss="modal" value="Hủy">
            <input onclick="" type="submit" class="btn btn-success" value="Xác nhận" id="submit-button" disabled>
        </div>
    </form>
